...
import { CommentItemById } from '../components/CommentItemById'
...
export const DetailSubCommentPage: FC = () => {
  const { commentParentId, commentId } = useParams() as {
  ...
  return (
    <>
      ...
      <CommentItemById commentId={commentParentId} />
        ...
        <>
          <div className='p-4 relative border-b border-b-outline-layout'>
            ...
            <p className='text-gray-500'>
              Replying to{' '}
              <Link
                to={`/${comment.comment!.user.username}`}
