  ...
  return (
    <div className='bg-black'>
      <div className='container mx-auto sm:px-0 md:px-0 lg:px-4 xl:px-30 2xl:px-40 w-full'>
        <main className='grid max-sm:grid-cols-sm sm:grid-cols-sm md:grid-cols-md lg:grid-cols-md xl:grid-cols-xl 2xl:grid-cols-lg divide-x divide-neutral-600 max-md:border-r max-md:border-neutral-600 w-full'>
          <VerticalNavbar />
